...
class ModelArguments:
    ...
    use_mean_pooling: bool = field(default=False)
...
class DataArguments:
    ...
    normalize_text: bool = field(default=False, metadata={"help": "Whether to normalize text"})

    lower_case: bool = field(default=False, metadata={"help": "Whether to lower case text"})
